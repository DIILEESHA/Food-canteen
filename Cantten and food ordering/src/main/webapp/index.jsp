...
<body id="page-top">
	...
	<nav style="background-color: #212529"
		...
		id="mainNav">
		<div style="background-color: #2C3E50; width: 100%" class="container">
			<a class="navbar-brand" href="#page-top">Food Master <img
				style="border-radius: 50%; height: 60px; width: 60px; object-fit: cover;"
				img-fluid" src="assets/img/logo2.png" alt="..." /></a>
			<button
	...
	<header class="masthead bg-primary text-white text-center">
		<div class="container d-flex align-items-center flex-column">
			...
			<img style="width: 90vw; height: 80vh; border-radius: 10px"
				class="masthead-avatar mb-5" src="assets/img/R.jpg" alt="..." />
			<!-- Masthead Heading-->
			...
			<p class="masthead-subheading font-weight-light mb-0">
				<span style="color: black">DELICIOUS</span> / LOOKS GOOD /<span
					style="color: black">FANCY</span> / YUMMY
			</p>
		</div>
	</header>
	<!-- Portfolio Section-->
		...
		<div class="container">
			...
			<div class="row justify-content-center">
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="" data-bs-toggle="" data-bs-target="">
						<div
						...
						<img
							style="border-radius: 10px; background-color: #222;border:3px solid black;width:1000px; height: 280px"
							class="img-fluid" src="assets/img/transport.png" alt="..." /> <a
							href="">
							<button
								style="border: none; background-color: teal; color: white; margin-top: 20px; margin-left: 5px; width: 340px; height: 40px"
								class="btn-me">ADD TRANSPORT</button>
						</a>
				...
				<div class="col-md-6 col-lg-4 mb-5">
					<div class="" data-bs-toggle="" data-bs-target="">
						...
						<img style="border-radius: 10px; background-color: #222;border:3px solid black"
							class="img-fluid" src="assets/img/emp.png" alt="..." /> <a
							href="Staff-insert.jsp">
							<button
								style="border: none; background-color: teal; color: white; margin-top: 20px; margin-left: 5px; width: 340px; height: 40px"
								class="btn-me">ADD EMPLOYEES</button>
						</a>
				...
				<div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
					<div class="" data-bs-toggle="" data-bs-target="">
						...
						<img
							style="border-radius: 10px; background-color: #222;border:3px solid black;width:700px; height: 280px"
							class="img-fluid" src="assets/img/financially.png" alt="..." /> <a
							href="">
							<button
								style="border: none; background-color: teal; color: white; margin-top: 20px; margin-left: 5px; width: 340px; height: 40px"
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 me-auto">
					<p class="lead">Duis aute irure dolor in reprehenderit in
			...
			<div class="text-center mt-4">
				<div style="margin: 10px; background-color: black"
					class=" mr-5 btn btn-xl btn-outline-light" href=""></div>
				<div style="margin: 10px; background-color: red"
					class="btn btn-xl btn-outline-light" href=""></div>
				<div style="margin: 10px; background-color: blue"
					class="btn btn-xl btn-outline-light" href=""></div>
				<div style="margin: 10px; background-color: white"
					class="btn btn-xl btn-outline-light" href=""></div>
				<div style="margin: 10px; background-color: crimson"
					class="btn btn-xl btn-outline-light" href=""></div>
			</div>
		</div>
	</section>
	...
	<!-- Footer-->
	<footer style="background-color: #2C3E50" class="footer text-center">
		<div class="container">
			<div class="row">
				<!-- Footer Location-->
	...
	<div class="copyright py-4 text-center text-white">
		<div class="container">
			<small>Copyright &copy; Your Food Master 2022</small>
		</div>
	</div>
	<!-- Portfolio Modals-->
	<!-- Portfolio Modal 1-->
